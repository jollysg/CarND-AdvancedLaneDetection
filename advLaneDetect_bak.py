...
#        unrectifiedImage = mpimg.imread(test_image_path)
...
#        t = t + 0.04
        ...
        # gChannel = ip.colorThreshold(image, 'g', (200, 255))
        # bChannel = ip.colorThreshold(image, 'b', (200, 255))
        # hChannel = ip.hlsThreshold(image, 'h', (15, 100))
        # lChannel = ip.hlsThreshold(image, 'l', (100, 255))
        ...
        combined = np.zeros_like(dirThreshImage)
        combined[(sobelxImage == 1) | (sChannel == 1)] = 1
    ...
    #
    # plt.subplot(4, 2, 2)
    # plt.imshow(rChannel, 'gray')
    # plt.xlabel('rChannel')
    # plt.xticks([], [])
    # plt.yticks([], [])
    #
    # plt.subplot(4, 2, 3)
    # plt.imshow(sobelxImage, 'gray')
    # plt.xlabel('sobelx')
    # plt.xticks([], [])
    # plt.yticks([], [])
    #
    # plt.subplot(4, 2, 4)
    # plt.imshow(sobelyImage, 'gray')
    # plt.xlabel('sobel y')
    # plt.xticks([], [])
    # plt.yticks([], [])
    #
    ...
    #
    # plt.subplot(4, 2, 6)
    # plt.imshow(magThreshImage, 'gray')
    # plt.xlabel('magthresh')
    # plt.xticks([], [])
    # plt.yticks([], [])
    #
    # plt.subplot(4, 2, 7)
    # plt.imshow(dirThreshImage, cmap = 'gray')
    # plt.xlabel('dir thresh Channel')
    # plt.xticks([], [])
    # plt.yticks([], [])
    #
    # plt.subplot(4, 2, 8)
    # plt.imshow(sChannel, 'gray')
    # plt.xlabel('sChannel')
    # plt.xticks([], [])
    # plt.yticks([], [])
    #
